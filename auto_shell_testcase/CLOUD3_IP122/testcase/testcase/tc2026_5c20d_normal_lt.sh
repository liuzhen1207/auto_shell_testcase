...
nohup bash ./start_bm_7d.sh '${arg}' > '${launcher_log}' 2>&1 < /dev/null &
sleep 1
pgrep -af \"start_bm_7d.sh ${arg}\" >/dev/null"
}
...
pgrep -af \"start_bm_7d.sh ${arg}\" >/dev/null && launcher_alive=1
