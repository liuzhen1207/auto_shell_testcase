...
wait_sync_done 180
   ...
   sql8="select count(s_0),count(s_1),count(s_2),count(s_3),count(s_4),count(s_5),count(s_6),count(s_7),count(s_8),count(s_9) from root.test.g_0.** where time>=2026-01-20T09:20:07.838+08:00 and time<=2026-01-21T09:20:07.838+08:00 align by device;"
   sql9="select device_id,count(s_0),count(s_1),count(s_2),count(s_3),count(s_4),count(s_5),count(s_6),count(s_7),count(s_8),count(s_9) from db_g_0.table1_0 where time>=2026-01-20T09:20:07.838+08:00 and time<=2026-01-21T09:20:07.838+08:00 group by device_id order by device_id;"
   sql10="select device_id,count(s_0),count(s_1),count(s_2),count(s_3),count(s_4),count(s_5),count(s_6),count(s_7),count(s_8),count(s_9) from db_g_0.table2_0 where time>=2026-01-20T09:20:07.838+08:00 and time<=2026-01-21T09:20:07.838+08:00 group by device_id order by device_id;"
   # all online
   exception_num=0
   while true
   do
...
#check log
#TTL SEC 1768953600 date -d"2026-01-21T08:00:00+08:00" +%s
ttl_time_point=1768953600000
v_cur_sec=$(date +%s)
