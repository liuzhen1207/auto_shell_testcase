...
check_log() {
  ...
  while read line<&3; do
     ...
     v_err_total=$((v_npe+v_err+v_err2+v_err3+v_err4+v_err5+v_err6+v_err7+v_err8+v_err9+v_err10+v_err11+v_err12+v_err13+v_err14+v_err15+v_err16+v_err17+v_err18+v_err19))
