...
check_res ${cur_dir}/tmp.out "success" 1
if [[ ${fail_flag} -gt 0 ]];then
        v_warnMessage="create table fail."
	return 1
fi

v_sql_ins_100="insert into db1.t_object(time,device_id,color,age,department ,file_type,file_content) values(2025-12-18T07:30:31.833+08:00,'d1','red',21,'dev','image',X'1abcde'),(2025-11-18T07:30:31.833+08:00,'d2','blue',22,'test','movie',X'1234'),(2025-12-24T07:30:31.833+08:00,'d3','green',24,'product','json',X'ab12'),(2026-1-8T07:30:31.833+08:00,'d1','blue',21,'dev','image',X'fabcde'),(2025-10-18T07:30:31.833+08:00,'d2','red',21,'dev','image',X'dabcde'),(2025-12-19T07:30:31.833+08:00,'d2','blue',22,'test','movie',X'1234'),(2026-1-7T07:30:31.833+08:00,'d3','green',24,'product','json',X'ab12'),(2026-11-7T07:30:31.833+08:00,'d3','green',24,'product','json',X'ab12');"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -sql_dialect table -e "${v_sql_ins_100}"  >${cur_dir}/tmp.out
check_res ${cur_dir}/tmp.out "IoTDBSQLException: 507: Fail to insert measurements" 1
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -sql_dialect table -e "select * from db1.t_object;" >${cur_dir}/tmp.out
check_res ${cur_dir}/tmp.out "null|" 8
