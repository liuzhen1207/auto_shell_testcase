...
user_name=root
db_user_name=sys_admin
sec_user=security_admin
db_ip=172.20.70.42
query_ip=${db_ip}
node_num=2
fail_flag=0
...
if [[ "${desc}" = "upgrade_from_v2061" ]];then
db_user_name=root
fi
# check status
while true
do
#
v_running_num=`${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${db_user_name} -e "show cluster;"|grep Running|wc -l`
...
function testcase1()
{
   ...
   start_dn_cn
   ${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -e "drop user pitt;create user pitt 'TimechoDB@2021';"
   ${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${db_user_name} -pw TimechoDB@2021 -sql_dialect table -e "grant system to user pitt;"
...
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "drop user pitt;" >${current_dir}/tmp.out
check_res "803: No permission to drop system admin" 1 "repeate_testcase2_3_4_5"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${db_user_name} -sql_dialect table -e "revoke system from user pitt;" >${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase2_3_4_5"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "drop user pitt;" >${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase2_3_4_5"

${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "create user pitt 'TimechoDB@2021';" >${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase2_3_4_5"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${db_user_name} -pw TimechoDB@2021 -sql_dialect table -e "grant system to user pitt;">${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase2_3_4_5"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u pitt -pw TimechoDB@2021 -e "show cluster;" >${current_dir}/tmp.out
...
date
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "drop user pitt;create user pitt 'TimechoDB@2021';" >${current_dir}/tmp.out
...
start_dn_cn
# drop user,create user
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "drop user pitt;"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "create user pitt 'TimechoDB@2021';" >${current_dir}/tmp.out
...
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u pitt -pw TimechoDB@2021 -e "show cluster;" >${current_dir}/tmp.out
check_res "Your password has not been changed for over 30 days" 1 "repeate"
# alter user pitt rename to santos (need revoke system first)
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${db_user_name} -pw TimechoDB@2021 -sql_dialect table -e "revoke system from user pitt;">${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase9_revoke"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "alter user pitt rename to santos;">${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase9"
...
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${db_user_name} -sql_dialect table -e "revoke system from user santos;" >${current_dir}/tmp.out
check_res "success" 1 "repeate_testcase9"

${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -pw TimechoDB@2021 -e "drop user santos;" >${current_dir}/tmp.out
...
check_res "The statement is executed successfully" 1 "repeate"
${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u pitt -pw TimechoDB@2021 -e "show cluster;" >${current_dir}/tmp.out
...
function testcase12()
{
   ...
   start_dn_cn "upgrade_from_v2061"
   sec_user=root
   ${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -e "list user;" >${current_dir}/tmp.out
   check_res "root" 1 "repeate"
   ...
   ${cli_dir}/sbin/start-cli.sh -h ${query_ip} -u ${sec_user} -sql_dialect table -e "list user;" >${current_dir}/tmp.out
   cat ${current_dir}/tmp.out
   check_res "root" 1 "repeate"
   check_res "hr_tree" 1 "repeate"
   check_res "all_priv_tree_user" 1 "repeate"
   ...
   cat ${current_dir}/tmp.out
  check_res "1970-01-01T08:01:00.000+08:00"  1 "repeate"
check_res "1970-01-01T08:01:10.000+08:00"  1 "repeate"
check_res "2025-09-29T15:25:57.415+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.326+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.425+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.429+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.437+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.444+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.449+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.454+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.458+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.470+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.474+08:00"  1 "repeate"
check_res "2025-09-29T15:25:57.508+08:00"  1 "repeate"
check_res "2025-09-30T15:25:57.479+08:00"  1 "repeate" 
   ...
   cat ${current_dir}/tmp.out
   check_res "1970-01-01T08:01:40.000+08:00" 1 "repeate"
   check_res "1970-01-01T08:03:20.000+08:00" 1 "repeate"
  # os +30d
if [[ ${user_name} = root ]];then
ssh ${user_name}@${db_ip} "date -s \"+30 day\""
else
...
testcase11
testcase12
echo "SUCCESS TESTCASE ${succ_flag},FAILED TESTCASE ${fail_flag},REPEATE FAILED TESTCASE ${fail_repeate_flag}"
echo "NPE TESTCASE NUMBER ${log_npe_flag}"
