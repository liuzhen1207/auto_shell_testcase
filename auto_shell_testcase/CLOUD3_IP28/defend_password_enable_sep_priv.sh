#!/bin/bash
current_dir=$(pwd)
db_dir=/home/cluster/v2091rc4_0415_ec67461/
cli_dir=/data/iotdb/v2091rc4_0415_ec67461/
...
# enable enable_separation_of_powers  
   ...
   if [[ ${v_param_exist_support} -gt 0 ]];then
           if [[ ${v_param_exist} = 0 ]];then
             ssh ${os_name}@${db_ip} "echo enable_separation_of_powers=true >> ${db_dir}/conf/iotdb-system.properties"
           else
             ssh ${os_name}@${db_ip} "sed -i 's/enable_separation_of_powers=.*/enable_separation_of_powers=true/g' ${db_dir}/conf/iotdb-system.properties"
           fi
   fi
...
ssh ${os_name}@${db_ip} "cp -rp ${db_dir}/conf ${db_dir}/conf_${v_t}_separation_true"
# check power
v_power=`ssh ${os_name}@${db_ip} "grep -E '^[[:space:]]*enable_separation_of_powers[[:space:]]*=[[:space:]]*true[[:space:]]*$' ${db_dir}/conf/iotdb-system.properties|wc -l"`
if [[ ${v_power} -gt 0 ]];then
db_admin_name=sys_admin
...
# enable_separation_of_powers=true, root create user javadi , javadi@client_ip28 Input the wrong password five times
function testcase1()
{
   stop_dn_cn
   remove_data_logs
copy_conf_from_backup
   ...
   test_user=javadi
   other_user=santos
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} ${ssl_str} -e "create user ${test_user} 'TimechoDB@2021';">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase1"
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} ${ssl_str} -e "create user ${other_user} 'TimechoDB@2021';">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase1"
...
# drop locked user
   ${cli_dir}/sbin/start-cli.sh -u ${db_admin_name} -h ${query_ip} -sql_dialect table ${ssl_str} -e "revoke system from user ${test_user};">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase1"
   ${cli_dir}/sbin/start-cli.sh -u ${db_admin_name} -h ${query_ip} -sql_dialect table ${ssl_str} -e "revoke system from user ${other_user};">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase1"

   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} ${ssl_str} -e "drop user ${test_user} ;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase1"
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} ${ssl_str} -e "drop user ${other_user} ;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase1"

   check_npe "testcase1"
}

# enable_separation_of_powers=true , security_admin create user javadi , failed_login_attempts_per_user test
function testcase2()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,  create user javadi , lock time test
function testcase3()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true , create user javadi , unlock user@ip
function testcase4()
{
   stop_dn_cn
   remove_data_logs
...
# unlock user@ip
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect tree ${ssl_str} -e "alter user ${test_user} @ '${this_shell_ip}' account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "testcase4"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${test_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase4"
# unlock santos@ip
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect tree ${ssl_str} -e "alter user ${other_user} @ '${this_shell_ip}' account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase4"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${other_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase4"
   ...
   check_res "822: Account is blocked due to consecutive failed logins" 1 "repeate_testcase4"
# unlock user@ip
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect table ${ssl_str} -e "alter user ${test_user} @ '${this_shell_ip}' account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase4"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${test_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase4"
# unlock santos@ip
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect table ${ssl_str} -e "alter user ${other_user} @ '${this_shell_ip}' account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase4"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${other_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase4"
...
# enable_separation_of_powers=true , create user javadi , unlock user
function testcase5()
{
   stop_dn_cn
   remove_data_logs
...
# unlock user
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect tree ${ssl_str} -e "alter user ${test_user} account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "testcase5"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${test_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase5"
# unlock santos
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect tree ${ssl_str} -e "alter user ${other_user} account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase5"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${test_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase5"
...
# unlock user
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect table ${ssl_str} -e "alter user ${test_user} account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase5"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${test_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase5"
# unlock santos
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 -sql_dialect table ${ssl_str} -e "alter user ${other_user} account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase5"
   # right password
   ${cli_dir}/sbin/start-cli.sh -u ${test_user} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "Running" ${node_num} "repeate_testcase5"
...
# enable_separation_of_powers=true,exempt user
function testcase6()
{
   stop_dn_cn
   remove_data_logs
copy_conf_from_backup
   ...
   for i in {1..5}
   do
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB ${ssl_str} -e "show cluster;">>${current_dir}/tmp.out
   done
   check_res "Authentication failed" 5 "repeate_testcase6"
   echo "">${current_dir}/tmp.out
# this client ip right password
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "822: Account is blocked due to consecutive failed logins" 1 "repeate_testcase6"

   # db_ip right password
   ssh ${os_name}@${db_ip} "${db_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -pw TimechoDB@2021 -h ${query_ip}  ${ssl_str} -e \"list user;\"">${current_dir}/tmp.out
   check_res "${db_sec_admin_name}" 1 "testcase6"
# this client ip right password
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "show cluster;">${current_dir}/tmp.out
   check_res "822: Account is blocked due to consecutive failed logins" 1 "repeate_testcase6"
# root unlock himself
   ssh ${os_name}@${db_ip} "${db_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -pw TimechoDB@2021 -h ${query_ip} -sql_dialect tree ${ssl_str} -e \"alter user ${db_sec_admin_name} @ '${this_shell_ip}' account unlock;\"">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase6"
# this client ip right password
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "list user;">${current_dir}/tmp.out
   check_res "${db_sec_admin_name}" 1 "repeate_testcase6"

   check_npe "testcase6"

}
# enable_separation_of_powers=true ,failed_login_attempts=-1 ,failed_login_attempts_per_user=10（默认值1000）,password_lock_time_minutes=1 ,用户被锁，等待自动解锁
function testcase7()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=-1 ,failed_login_attempts_per_user=10（默认值1000）,password_lock_time_minutes=1 ,用户在2个客户端，总次数被锁，用户被锁，等待自动解锁
function testcase8()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true,failed_login_attempts=0 ,failed_login_attempts_per_user=1（默认值1000）,password_lock_time_minutes=1 ,用户IP被锁，等待自动解锁
function testcase9()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=-1 ,failed_login_attempts_per_user=10（默认值1000）,password_lock_time_minutes=10 ,用户被锁，解锁user IP 无效,unlock 用户锁有效
function testcase10()
{
   stop_dn_cn
   remove_data_logs
...
# this client ip right password
   ...
   check_res "Running" ${node_num} "repeate_testcase10"
# unlock user IP
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "alter user ${test_user} @ '${this_shell_ip}' account unlock;">${current_dir}/tmp.out
...
# unlock user
   ${cli_dir}/sbin/start-cli.sh -u ${db_sec_admin_name} -h ${query_ip} -pw TimechoDB@2021 ${ssl_str} -e "alter user ${test_user} account unlock;">${current_dir}/tmp.out
   check_res "success" 1 "repeate_testcase10"
...
# enable_separation_of_powers=true ,failed_login_attempts=5 ,failed_login_attempts_per_user=-1（默认值1000）,password_lock_time_minutes=10 ,failed_login_attempts_per_user reset 1000
function testcase12()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=5 ,failed_login_attempts_per_user=0（默认值1000）,password_lock_time_minutes=10 ,start datanode has error
function testcase13()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=-1 ,failed_login_attempts_per_user=-1（默认值1000）,password_lock_time_minutes=10 ,never lock
function testcase14()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=5 ,failed_login_attempts_per_user=1（默认值1000）,password_lock_time_minutes=10 , user < user_ip
function testcase15()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=5 ,failed_login_attempts_per_user=5（默认值1000）,password_lock_time_minutes=10 , user = user_ip
function testcase16()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=5 ,failed_login_attempts_per_user=1000（默认值1000）,password_lock_time_minutes=-1
function testcase17()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true ,failed_login_attempts=5 ,failed_login_attempts_per_user=1000（默认值1000）,password_lock_time_minutes=0
function testcase18()
{
   stop_dn_cn
   remove_data_logs
...
# enable_separation_of_powers=true,ns 时间戳 failed_login_attempts=5 ,failed_login_attempts_per_user=5（默认值1000）,password_lock_time_minutes=1
function testcase19()
{
   stop_dn_cn
   remove_data_logs
